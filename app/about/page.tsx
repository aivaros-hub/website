      ...
      <section className="py-20 bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center">
            <p className="text-2xl text-gray-700 dark:text-gray-200 leading-relaxed font-medium">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center p-8">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Customer-Centric</h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
            ...
            <div className="text-center p-8">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Trust & Security</h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
