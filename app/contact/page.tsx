      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="mt-12">
                ...
                <div className="flex items-center space-x-4">
                  <a
                    ...
                    className="w-10 h-10 rounded-lg bg-gray-100 hover:bg-purple-100 flex items-center justify-center text-gray-600 hover:text-purple-600 transition-colors"
                  >
            ...
            {/* Contact Form */}
            <div className="bg-gradient-to-br from-gray-50 to-white p-8 sm:p-10 rounded-3xl border-2 border-gray-200">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    } focus:border-purple-500 focus:ring-4 focus:ring-purple-100 outline-none transition-all`}
                ...
                <div>
                  ...
                  <input
                    ...
                    value={formData.role}
                    onChange={handleChange}
                    className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 bg-white focus:border-purple-500 focus:ring-4 focus:ring-purple-100 outline-none transition-all"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleChange}
                    className={`w-full px-4 py-3 rounded-xl border-2 ${
                      errors.interest ? "border-red-300 bg-red-50" : "border-gray-200 bg-white"
                    } focus:border-purple-500 focus:ring-4 focus:ring-purple-100 outline-none transition-all`}
                  >
                    <option value="">Select an option</option>
                    <option value="metatalio">MetaTalio (HR & Workforce)</option>
                    <option value="enterprise">Enterprise Automation (DevOps/QA/Security)</option>
                    <option value="healthcare">Healthcare Agents</option>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    } focus:border-purple-500 focus:ring-4 focus:ring-purple-100 outline-none transition-all resize-none`}
