...
export default function ProductsPage() {
  return (
    <div className="pt-20">
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-b from-white via-gray-50 to-white py-20 sm:py-32">
      ...
      {/* MetaTalio Suite */}
      <section id="metatalio" className="py-20 bg-white scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                <span className="text-purple-600">MetaTalio</span> Suite
              </h2>
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 rounded-2xl bg-purple-50 border border-purple-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">AI-Powered ATS</h4>
                    <p className="text-gray-600 text-sm">Intelligent resume parsing, candidate enrichment, and automated job matching</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-purple-50 border border-purple-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Recruitment Automation</h4>
                    <p className="text-gray-600 text-sm">Automated outreach, candidate screening, and interview scheduling</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-purple-50 border border-purple-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">HRMS & Payroll</h4>
                    <p className="text-gray-600 text-sm">Complete HR management system with automated payroll processing</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-purple-50 border border-purple-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">IT Employee Lifecycle</h4>
                    <p className="text-gray-600 text-sm">Equipment provisioning, access management, and onboarding automation</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-purple-50 border border-purple-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Workforce Analytics</h4>
                    <p className="text-gray-600 text-sm">Real-time insights, productivity tracking, and predictive analytics</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-purple-50 border border-purple-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Timesheets & Compliance</h4>
                    <p className="text-gray-600 text-sm">Automated time tracking and regulatory compliance management</p>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section id="enterprise" className="py-20 bg-gradient-to-b from-blue-50 to-white scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="order-2 lg:order-1 space-y-6">
              ...
              <div className="p-6 rounded-2xl bg-blue-50 border border-blue-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">DevOps Automation</h4>
                    <p className="text-gray-600 text-sm">CI/CD pipeline orchestration and infrastructure as code management</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-blue-50 border border-blue-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Automated test generation, execution, and regression testing</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-blue-50 border border-blue-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Security Enablement</h4>
              ...
              <div className="p-6 rounded-2xl bg-blue-50 border border-blue-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Documentation Agents</h4>
                    <p className="text-gray-600 text-sm">Automated documentation generation and code review assistance</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-blue-50 border border-blue-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Real-time monitoring, anomaly detection, and optimization recommendations</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                <span className="text-blue-600">Enterprise Automation</span> Suite
              </h2>
              <p className="text-xl text-gray-600 mb-6">
      ...
      {/* Healthcare Suite */}
      <section id="healthcare" className="py-20 bg-white scroll-mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold text-gray-900 mb-4">
                <span className="text-teal-600">Healthcare</span> Agent Suite
              </h2>
              <p className="text-xl text-gray-600 mb-6">
            ...
            <div className="space-y-6">
              ...
              <div className="p-6 rounded-2xl bg-teal-50 border border-teal-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Patient Onboarding</h4>
                    <p className="text-gray-600 text-sm">Automated intake, health history collection, and registration workflows</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-teal-50 border border-teal-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-sm">Intelligent booking, reminders, and calendar optimization</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-teal-50 border border-teal-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">EMR Documentation</h4>
                    <p className="text-gray-600 text-sm">AI-assisted note generation and medical record management</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-teal-50 border border-teal-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Insurance Workflows</h4>
              ...
              <div className="p-6 rounded-2xl bg-teal-50 border border-teal-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Patient Communication</h4>
                    <p className="text-gray-600 text-sm">Automated follow-ups, health reminders, and patient engagement</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-6 rounded-2xl bg-teal-50 border border-teal-100">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-900 mb-2">Operational Analytics</h4>
                    <p className="text-gray-600 text-sm">Patient flow insights, resource optimization, and revenue cycle analytics</p>
                  </div>
                </div>
              </div>
            </div>
